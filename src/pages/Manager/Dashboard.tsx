...
const ManagerDashboard: React.FC = () => {
  ...
  useEffect(() => {
    const fetchManagerData = async () => {
      try {
        ...
        const dashboardData: DashboardData = await managerService.getManagerDashboard(profile._id);
        setDeliveryStats({
          total: dashboardData.totalDeliveryPartners,
          active: dashboardData.activePartners,
          pending: dashboardData.pendingPartners,
          available: dashboardData.verifiedPartners
        });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50">
      ...
      <div className="container mx-auto px-6 py-8">
        {/* Delivery Partner Stats Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {/* Total Delivery Partners Card */}
          <div className="bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 rounded-2xl shadow-xl p-6 text-white hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="text-lg font-semibold text-blue-100">Total Delivery Partners</h3>
                <p className="text-blue-200 text-sm">All registered partners</p>
              </div>
            ...
            <div className="flex items-end justify-between">
              <div className="text-3xl font-bold">{deliveryStats.total}</div>
              <div className="text-blue-200 text-sm">Partners</div>
            </div>
          </div>

          {/* Active Delivery Partners Card */}
          <div className="bg-gradient-to-br from-green-500 via-green-600 to-green-700 rounded-2xl shadow-xl p-6 text-white hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="text-lg font-semibold text-green-100">Active Delivery Partners</h3>
                <p className="text-green-200 text-sm">Currently working</p>
              </div>
              <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-end justify-between">
              <div className="text-3xl font-bold">{deliveryStats.active}</div>
              <div className="text-green-200 text-sm">Active</div>
            </div>
          </div>

          {/* Pending Delivery Partners Card */}
          <div className="bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 rounded-2xl shadow-xl p-6 text-white hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="text-lg font-semibold text-orange-100">Pending Delivery Partners</h3>
                <p className="text-orange-200 text-sm">Awaiting approval</p>
              </div>
              <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-end justify-between">
              <div className="text-3xl font-bold">{deliveryStats.pending}</div>
              <div className="text-orange-200 text-sm">Pending</div>
            </div>
          </div>

          {/* Available Delivery Partners Card */}
          <div className="bg-gradient-to-br from-purple-500 via-purple-600 to-purple-700 rounded-2xl shadow-xl p-6 text-white hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="text-lg font-semibold text-purple-100">Available Delivery Partners</h3>
                <p className="text-purple-200 text-sm">Ready for assignments</p>
              </div>
              <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-end justify-between">
              <div className="text-3xl font-bold">{deliveryStats.available}</div>
