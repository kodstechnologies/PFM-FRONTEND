...
// // // import { RefreshCw } from "lucide-react"; // Added for reload icon
...
// // // /* ================= COMPONENT ================= */
// // // const LiveOrdersPageNoBtn: React.FC = () => {
...
// // // export default LiveOrdersPageNoBtn;
...
import React, { useEffect, useState, useCallback } from "react";
import { useNavigate } from "react-router-dom";
import { RefreshCw, ArrowLeft } from "lucide-react"; // Added for reload and back icons
import axios from "axios";
import OrderColumn from "./OrderColumn";
import { API_CONFIG } from "../../../config/api.config";
...
const LiveOrdersPageNoBtn: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-screen bg-gray-900 text-white overflow-hidden">
            {/* 🔹 TOP HEADER: Back + Store Name + Reload + Logout */}
            <header className="bg-gray-800 border-b border-gray-700 p-4 flex justify-between items-center">
                <div className="flex items-center gap-4">
                    <button
                        onClick={handleBack}
