...
// //     console.log('🚀 ~ TypeCategoriesDisplay ~ location.state.id:', (location.state as { id?: string })?.id);
// //     console.log('🚀 ~ TypeCategoriesDisplay ~ id used:', id);
...
// //                                 />
// //                             </svg>
// //                             <h3 className="mt-2 text-lg font-medium text-gray-900">No type categories found</h3>
...
const TypeCategoriesDisplay: React.FC = () => {
    ...
    const getTypeCategoryImage = (typeCategory: TypeCategory): string | null => {
        // Use the MongoDB image if available and valid
        if (typeCategory.img && typeof typeCategory.img === 'string' && typeCategory.img.startsWith('http')) {
            return typeCategory.img;
        }
        // Return null instead of a default image
        return null;
    };
