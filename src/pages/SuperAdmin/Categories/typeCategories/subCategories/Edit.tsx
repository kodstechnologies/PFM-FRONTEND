...
// // //                                 })}
// // //                                 className={`block w-full px-4 py-2 border rounded-lg shadow-sm sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-300 transition ${errors.quantity ? 'border-red-400' : 'border-gray-300'}`}
// // //                                 placeholder={`Enter ${watchedUnit === 'pieces' ? 'pieces' : 'quantity'} (e.g., 1.5)`}
// // //                                 aria-invalid={errors.quantity ? 'true' : 'false'}
// // //                             />
// // //                             {errors.quantity && (
// // //                                 <p className="mt-1 text-xs text-red-600" role="alert">
...
// //             const stepValue = isPieces ? 1 : 0.01;
...
// //                                 id="quantity"
// //                                 type="number"
// //                                 step={watchedUnit?.toLowerCase().includes('piece') ? 1 : 0.01}
...
// //                                     },
// //                                     validate: (value) => {
// //                                         if (watchedUnit?.toLowerCase().includes('piece') && !Number.isInteger(Number(value))) {
...
//                                         case 'kg': return 'Enter weight in kg (e.g., 1.5)';
//                                         case 'gram': return 'Enter weight in g (e.g., 1000)';
//                                         default: return 'Enter quantity (e.g., 1.5)';
//                                     }
//                                 })()}
//                                 aria-invalid={errors.quantity ? 'true' : 'false'}
//                             />
