  ...
  const onSubmit: SubmitHandler<FormInputs> = async (data) => {
    ...
    try {
      ...
      if (!response.data.success) {
        throw new Error(response.data.message || 'Failed to create meat center');
      }
      ...
      const errorMessage = error instanceof Error ? error.message : 'Failed to create meat center';
      console.error('Error creating meat center:', errorMessage);
