...
//           "name",
//           "location",
//           { name: "manager", getFn: (store) => store.manager || "" },
//           { name: "managerEmail", getFn: (store) => store.managerEmail || "" },
//           "lat",
//           "long",
//           "phone",
//           "pincode",
...
//           url: `/admin/meat-centers/${row.id}`, // Handle both id formats
//           method: "DELETE",
//         })
...
//               <input
//                 type="text"
//                 placeholder="Search stores by name, location, manager, manager phone, store phone, pincode, or products..."
//                 value={globalFilter}
        ...
        <div className="bg-white shadow-sm rounded-xl border border-gray-100 overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row gap-4 p-6 border-b border-gray-100">
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Search stores by name, location, manager, manager phone, store phone, or pincode..."
                value={globalFilter}
                onChange={(e) => setGlobalFilter(e.target.value)}
                className="pl-10 pr-4 py-2.5 w-full border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition placeholder-gray-400"
              />
