...
const ManagerLogin = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      Cookies.set('managerAccessToken', responseData.accessToken, { path: '/', secure: true, sameSite: 'Strict', expires: 1 }); // 1 day
      Cookies.set('managerRefreshToken', responseData.refreshToken, { path: '/', secure: true, sameSite: 'Strict', expires: 7 }); // 7 days
