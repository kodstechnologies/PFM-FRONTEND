...
const SubCategoriesDisplay: React.FC = () => {
            ...
            <div className="py-6">
                <div className="mb-6">
                    <div className="flex flex-col sm:flex-row md:items-center items-end sm:justify-between gap-5">
                        ...
                        <button onClick={() => openAdd()} className="bg-gradient-to-r from-[#e11d48] to-[#f87171] hover:from-[#be123c] hover:to-[#ef4444] px-4 py-2 rounded text-white font-semibold transition">
    ...
    return (
        <>
                    ...
                    <div className="flex flex-col sm:flex-row md:items-center items-end sm:justify-between gap-5">
                        ...
                        <div className="flex items-center gap-3 w-full sm:w-auto">
                            <input
                                ...
                                onChange={(e) => setSearch(e.target.value)}
                                placeholder="Search subcategories..."
                                className="w-full sm:w-72 border rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#e11d48]"
                            />
                            <button onClick={() => openAdd()} className="bg-gradient-to-r from-[#e11d48] to-[#f87171] hover:from-[#be123c] hover:to-[#ef4444] px-4 py-2 rounded text-white font-semibold transition">
                                <AddIcon fontSize="small" className="mr-1" />
                                <span>Add</span>
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {filtered.map((item, index) => (
                                    <tr key={item._id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-2">
                                                <button onClick={() => openView(item)} className="inline-flex items-center gap-1 border rounded px-3 py-1.5 text-xs text-blue-600 hover:bg-blue-50 transition-colors">
                                                    <VisibilityIcon fontSize="small" />
                                                    <span>View</span>
                                                </button>
                                                <button onClick={() => openEdit(item)} className="inline-flex items-center gap-1 border rounded px-3 py-1.5 text-xs text-green-600 hover:bg-green-50 transition-colors">
                                                    <EditIcon fontSize="small" />
                                                    <span>Edit</span>
                                                </button>
                                                <button onClick={() => handleDelete(item)} className="inline-flex items-center gap-1 border rounded px-3 py-1.5 text-xs text-red-600 hover:bg-red-50 transition-colors">
                                                    <DeleteIcon fontSize="small" />
                                                    <span>Delete</span>
                                                </button>
                                            </div>
            ...
            {/* View Dialog */}
            <Dialog open={viewOpen} onClose={() => setViewOpen(false)} maxWidth="md" fullWidth>
                <DialogTitle className="bg-gradient-to-r from-[#e11d48] to-[#f87171] text-white">
                ...
                <DialogActions>
                    <Button
                        ...
                        className="bg-gradient-to-r from-[#e11d48] to-[#f87171] hover:from-[#be123c] hover:to-[#ef4444] px-4 py-2 rounded text-white font-semibold transition"
                    >
                        Close
                    </Button>
                </DialogActions>
